...
_thread_join:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  15:	8b 58 04             	mov    0x4(%eax),%ebx
  18:	ff 30                	pushl  (%eax)
  1a:	e8 e1 01 00 00       	call   200 <atoi>
  1f:	5a                   	pop    %edx
  20:	59                   	pop    %ecx
  21:	53                   	push   %ebx
  22:	50                   	push   %eax
  23:	e8 1a 03 00 00       	call   342 <thread_join>
  exit();
  28:	e8 45 02 00 00       	call   272 <exit>
  2d:	66 90                	xchg   %ax,%ax
  2f:	90                   	nop
...
free(void *ap)
{
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 64d:	a3 f4 09 00 00       	mov    %eax,0x9f4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 f4 09 00 00    	mov    0x9f4,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6bf:	76 3f                	jbe    700 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	39 05 f4 09 00 00    	cmp    %eax,0x9f4
 ...
 6e6:	e8 e5 fe ff ff       	call   5d0 <free>
  return freep;
 6eb:	8b 15 f4 09 00 00    	mov    0x9f4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 70c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 70f:	89 15 f4 09 00 00    	mov    %edx,0x9f4
      return (void*)(p + 1);
 ...
 724:	eb e9                	jmp    70f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 f4 09 00 00 f8 	movl   $0x9f8,0x9f4
 72d:	09 00 00 
 730:	c7 05 f8 09 00 00 f8 	movl   $0x9f8,0x9f8
 737:	09 00 00 
    base.s.size = 0;
 73a:	b8 f8 09 00 00       	mov    $0x9f8,%eax
 73f:	c7 05 fc 09 00 00 00 	movl   $0x0,0x9fc
 746:	00 00 00 
