...
_thread_create:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  14:	ff 70 08             	pushl  0x8(%eax)
  17:	ff 70 04             	pushl  0x4(%eax)
  1a:	ff 30                	pushl  (%eax)
  1c:	e8 11 03 00 00       	call   332 <thread_create>
  exit();
  21:	e8 4c 02 00 00       	call   272 <exit>
  26:	66 90                	xchg   %ax,%ax
  28:	66 90                	xchg   %ax,%ax
  2a:	66 90                	xchg   %ax,%ax
  2c:	66 90                	xchg   %ax,%ax
...
00000332 <thread_create>:
SYSCALL(thread_create)
 332:	b8 1a 00 00 00       	mov    $0x1a,%eax
 337:	cd 40                	int    $0x40
 339:	c3                   	ret    

0000033a <thread_exit>:
SYSCALL(thread_exit)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cf:	f7 f6                	div    %esi
 3d1:	0f b6 92 58 07 00 00 	movzbl 0x758(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 408:	e8 85 fe ff ff       	call   292 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 4da:	50                   	push   %eax
 4db:	57                   	push   %edi
 4dc:	e8 b1 fd ff ff       	call   292 <write>
 ...
 4f1:	e8 9c fd ff ff       	call   292 <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 548:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 54b:	b8 50 07 00 00       	mov    $0x750,%eax
...
putc(int fd, char c)
{
 ...
 5bf:	50                   	push   %eax
 5c0:	57                   	push   %edi
 5c1:	e8 cc fc ff ff       	call   292 <write>
...
free(void *ap)
{
 ...
 5d1:	a1 f0 09 00 00       	mov    0x9f0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 627:	89 08                	mov    %ecx,(%eax)
  freep = p;
 629:	a3 f0 09 00 00       	mov    %eax,0x9f0
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 64d:	a3 f0 09 00 00       	mov    %eax,0x9f0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 f0 09 00 00    	mov    0x9f0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6bf:	76 3f                	jbe    700 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	39 05 f0 09 00 00    	cmp    %eax,0x9f0
 ...
 6e6:	e8 e5 fe ff ff       	call   5d0 <free>
  return freep;
 6eb:	8b 15 f0 09 00 00    	mov    0x9f0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 70c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 70f:	89 15 f0 09 00 00    	mov    %edx,0x9f0
      return (void*)(p + 1);
 ...
 724:	eb e9                	jmp    70f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 f0 09 00 00 f4 	movl   $0x9f4,0x9f0
 72d:	09 00 00 
 730:	c7 05 f4 09 00 00 f4 	movl   $0x9f4,0x9f4
 737:	09 00 00 
    base.s.size = 0;
 73a:	b8 f4 09 00 00       	mov    $0x9f4,%eax
 73f:	c7 05 f8 09 00 00 00 	movl   $0x0,0x9f8
 746:	00 00 00 
