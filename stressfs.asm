...
0000044a <thread_exit>:
SYSCALL(thread_exit)
 44a:	b8 1b 00 00 00       	mov    $0x1b,%eax
 44f:	cd 40                	int    $0x40
 451:	c3                   	ret    

00000452 <thread_join>:
SYSCALL(thread_join)
...
0000048a <cond_signal>:
SYSCALL(cond_signal)
 48a:	b8 23 00 00 00       	mov    $0x23,%eax
 48f:	cd 40                	int    $0x40
 491:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4df:	f7 f6                	div    %esi
 4e1:	0f b6 92 8c 08 00 00 	movzbl 0x88c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 518:	e8 85 fe ff ff       	call   3a2 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 5ea:	50                   	push   %eax
 5eb:	57                   	push   %edi
 5ec:	e8 b1 fd ff ff       	call   3a2 <write>
 ...
 601:	e8 9c fd ff ff       	call   3a2 <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 658:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 65b:	b8 83 08 00 00       	mov    $0x883,%eax
...
putc(int fd, char c)
{
 ...
 6cf:	50                   	push   %eax
 6d0:	57                   	push   %edi
 6d1:	e8 cc fc ff ff       	call   3a2 <write>
...
free(void *ap)
{
 ...
 6e1:	a1 30 0b 00 00       	mov    0xb30,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 737:	89 08                	mov    %ecx,(%eax)
  freep = p;
 739:	a3 30 0b 00 00       	mov    %eax,0xb30
}
 73e:	5b                   	pop    %ebx
 73f:	5e                   	pop    %esi
 740:	5f                   	pop    %edi
 ...
 75a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 75d:	a3 30 0b 00 00       	mov    %eax,0xb30
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 15 30 0b 00 00    	mov    0xb30,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 7cf:	76 3f                	jbe    810 <malloc+0xa0>
    ...
    if(p == freep)
 7d1:	39 05 30 0b 00 00    	cmp    %eax,0xb30
 ...
 7f6:	e8 e5 fe ff ff       	call   6e0 <free>
  return freep;
 7fb:	8b 15 30 0b 00 00    	mov    0xb30,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 81c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 81f:	89 15 30 0b 00 00    	mov    %edx,0xb30
      return (void*)(p + 1);
 ...
 834:	eb e9                	jmp    81f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 836:	c7 05 30 0b 00 00 34 	movl   $0xb34,0xb30
 83d:	0b 00 00 
 840:	c7 05 34 0b 00 00 34 	movl   $0xb34,0xb34
 847:	0b 00 00 
    base.s.size = 0;
 84a:	b8 34 0b 00 00       	mov    $0xb34,%eax
 84f:	c7 05 38 0b 00 00 00 	movl   $0x0,0xb38
 856:	00 00 00 
