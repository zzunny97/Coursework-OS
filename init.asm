...
main(void)
{
  ...
  52:	e8 b9 04 00 00       	call   510 <printf>
	printf(1, "Student ID: 2016312029\n");
  57:	58                   	pop    %eax
  58:	5a                   	pop    %edx
  59:	68 4b 08 00 00       	push   $0x84b
  5e:	6a 01                	push   $0x1
  60:	e8 ab 04 00 00       	call   510 <printf>
	printf(1, "Name: Hyeongjun Park\n");
  65:	59                   	pop    %ecx
  66:	5b                   	pop    %ebx
  67:	68 63 08 00 00       	push   $0x863
  6c:	6a 01                	push   $0x1
  6e:	e8 9d 04 00 00       	call   510 <printf>
    pid = fork();
  73:	e8 d2 02 00 00       	call   34a <fork>
    if(pid < 0){
  ...
  a9:	53                   	push   %ebx
  aa:	53                   	push   %ebx
  ab:	68 79 08 00 00       	push   $0x879
  b0:	6a 01                	push   $0x1
  b2:	e8 59 04 00 00       	call   510 <printf>
      exit();
  b7:	e8 96 02 00 00       	call   352 <exit>
    }
    if(pid == 0){
      exec("sh", argv);
  bc:	50                   	push   %eax
  bd:	50                   	push   %eax
  be:	68 54 0b 00 00       	push   $0xb54
  c3:	68 8c 08 00 00       	push   $0x88c
  c8:	e8 bd 02 00 00       	call   38a <exec>
      printf(1, "init: exec sh failed\n");
  cd:	5a                   	pop    %edx
  ce:	59                   	pop    %ecx
  cf:	68 8f 08 00 00       	push   $0x88f
  d4:	6a 01                	push   $0x1
  d6:	e8 35 04 00 00       	call   510 <printf>
      exit();
  db:	e8 72 02 00 00       	call   352 <exit>
main(void)
{
  int pid, wpid;
  ...
  e1:	6a 01                	push   $0x1
  e3:	6a 01                	push   $0x1
  e5:	68 30 08 00 00       	push   $0x830
  ea:	e8 ab 02 00 00       	call   39a <mknod>
    open("console", O_RDWR);
  ef:	58                   	pop    %eax
  f0:	5a                   	pop    %edx
  f1:	6a 02                	push   $0x2
  f3:	68 30 08 00 00       	push   $0x830
  f8:	e8 95 02 00 00       	call   392 <open>
...
00000452 <cond_wait>:
SYSCALL(cond_wait)
 452:	b8 22 00 00 00       	mov    $0x22,%eax
 457:	cd 40                	int    $0x40
 459:	c3                   	ret    

0000045a <cond_signal>:
SYSCALL(cond_signal)
 45a:	b8 23 00 00 00       	mov    $0x23,%eax
 45f:	cd 40                	int    $0x40
 461:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4af:	f7 f6                	div    %esi
 4b1:	0f b6 92 b8 08 00 00 	movzbl 0x8b8(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4e8:	e8 85 fe ff ff       	call   372 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 5ba:	50                   	push   %eax
 5bb:	57                   	push   %edi
 5bc:	e8 b1 fd ff ff       	call   372 <write>
 ...
 5d1:	e8 9c fd ff ff       	call   372 <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 628:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 62b:	b8 ae 08 00 00       	mov    $0x8ae,%eax
...
putc(int fd, char c)
{
 ...
 69f:	50                   	push   %eax
 6a0:	57                   	push   %edi
 6a1:	e8 cc fc ff ff       	call   372 <write>
...
free(void *ap)
{
 ...
 707:	89 08                	mov    %ecx,(%eax)
  freep = p;
 709:	a3 5c 0b 00 00       	mov    %eax,0xb5c
}
 70e:	5b                   	pop    %ebx
 70f:	5e                   	pop    %esi
 710:	5f                   	pop    %edi
 ...
 72a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 72d:	a3 5c 0b 00 00       	mov    %eax,0xb5c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 79f:	76 3f                	jbe    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 7a1:	39 05 5c 0b 00 00    	cmp    %eax,0xb5c
 ...
 7c6:	e8 e5 fe ff ff       	call   6b0 <free>
  return freep;
 7cb:	8b 15 5c 0b 00 00    	mov    0xb5c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7ec:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7ef:	89 15 5c 0b 00 00    	mov    %edx,0xb5c
      return (void*)(p + 1);
 ...
 804:	eb e9                	jmp    7ef <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 806:	c7 05 5c 0b 00 00 60 	movl   $0xb60,0xb5c
 80d:	0b 00 00 
 810:	c7 05 60 0b 00 00 60 	movl   $0xb60,0xb60
 817:	0b 00 00 
    base.s.size = 0;
 81a:	b8 60 0b 00 00       	mov    $0xb60,%eax
 81f:	c7 05 64 0b 00 00 00 	movl   $0x0,0xb64
 826:	00 00 00 
