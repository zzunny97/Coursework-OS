...
putc(int fd, char c)
{
 ...
 578:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 57b:	b8 a7 07 00 00       	mov    $0x7a7,%eax
...
free(void *ap)
{
 ...
 67a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 67d:	a3 4c 0a 00 00       	mov    %eax,0xa4c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 716:	e8 e5 fe ff ff       	call   600 <free>
  return freep;
 71b:	8b 15 4c 0a 00 00    	mov    0xa4c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 754:	eb e9                	jmp    73f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 756:	c7 05 4c 0a 00 00 50 	movl   $0xa50,0xa4c
 75d:	0a 00 00 
 760:	c7 05 50 0a 00 00 50 	movl   $0xa50,0xa50
 767:	0a 00 00 
    base.s.size = 0;
 76a:	b8 50 0a 00 00       	mov    $0xa50,%eax
 76f:	c7 05 54 0a 00 00 00 	movl   $0x0,0xa54
 776:	00 00 00 
