...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      7d:	80 3d c0 18 00 00 63 	cmpb   $0x63,0x18c0
      84:	75 ca                	jne    50 <main+0x50>
      86:	80 3d c1 18 00 00 64 	cmpb   $0x64,0x18c1
...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      if(chdir(buf+3) < 0)
      b3:	c7 04 24 c3 18 00 00 	movl   $0x18c3,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      // Chdir must be called by the parent, not the child.
      buf[strlen(buf)-1] = 0;  // chop \n
      ba:	c6 80 bf 18 00 00 00 	movb   $0x0,0x18bf(%eax)
      if(chdir(buf+3) < 0)
      ...
      cb:	79 9a                	jns    67 <main+0x67>
        printf(2, "cannot cd %s\n", buf+3);
      cd:	50                   	push   %eax
      ce:	68 c3 18 00 00       	push   $0x18c3
      d3:	68 a9 12 00 00       	push   $0x12a9
      d8:	6a 02                	push   $0x2
      da:	e8 01 0e 00 00       	call   ee0 <printf>
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     ...
     123:	6a 02                	push   $0x2
     125:	e8 b6 0d 00 00       	call   ee0 <printf>
  memset(buf, 0, nbuf);
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     16e:	6a 02                	push   $0x2
     170:	e8 6b 0d 00 00       	call   ee0 <printf>
  exit();
...
fork1(void)
{
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     23b:	6a 02                	push   $0x2
     23d:	e8 9e 0c 00 00       	call   ee0 <printf>
    break;
     ...
     297:	e8 c4 fe ff ff       	call   160 <panic>
{
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     2b2:	6a 02                	push   $0x2
     2b4:	e8 27 0c 00 00       	call   ee0 <printf>
      exit();
     ...
     341:	c3                   	ret    
{
  ...
  if(pid == -1)
    panic("fork");
     ...
     345:	68 2a 12 00 00       	push   $0x122a
     ...
     4a0:	83 c7 01             	add    $0x1,%edi
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4b1:	50                   	push   %eax
     4b2:	68 a8 18 00 00       	push   $0x18a8
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     505:	50                   	push   %eax
     506:	68 a8 18 00 00       	push   $0x18a8
  ...
  *ps = s;
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     556:	50                   	push   %eax
     557:	68 a0 18 00 00       	push   $0x18a0
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     575:	50                   	push   %eax
     576:	68 a8 18 00 00       	push   $0x18a8
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     61d:	50                   	push   %eax
     61e:	68 a8 18 00 00       	push   $0x18a8
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     673:	68 51 12 00 00       	push   $0x1251
     678:	53                   	push   %ebx
     679:	56                   	push   %esi
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     6fe:	68 34 12 00 00       	push   $0x1234
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     71f:	68 54 12 00 00       	push   $0x1254
     724:	57                   	push   %edi
     725:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     776:	68 6b 12 00 00       	push   $0x126b
     77b:	57                   	push   %edi
     77c:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     7c2:	68 5d 12 00 00       	push   $0x125d
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     80d:	68 56 12 00 00       	push   $0x1256
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     83b:	68 70 12 00 00       	push   $0x1270
     840:	56                   	push   %esi
     841:	53                   	push   %ebx
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     8cb:	68 72 12 00 00       	push   $0x1272
     8d0:	56                   	push   %esi
     8d1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8e1:	68 6e 12 00 00       	push   $0x126e
     8e6:	56                   	push   %esi
     8e7:	53                   	push   %ebx
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     93f:	68 54 12 00 00       	push   $0x1254
     944:	56                   	push   %esi
     945:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     96b:	68 90 12 00 00       	push   $0x1290
     970:	56                   	push   %esi
     971:	53                   	push   %ebx
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
    panic("parseblock");
     ...
     99f:	68 74 12 00 00       	push   $0x1274
  ...
  if(!peek(ps, es, ")"))
    panic("syntax - missing )");
     ...
     9ac:	68 7f 12 00 00       	push   $0x127f
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9d9:	ff 24 85 d0 12 00 00 	jmp    *0x12d0(,%eax,4)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     a97:	68 19 12 00 00       	push   $0x1219
     a9c:	53                   	push   %ebx
     a9d:	50                   	push   %eax
  ...
  if(s != es){
    printf(2, "leftovers: %s\n", s);
     abf:	52                   	push   %edx
     ac0:	50                   	push   %eax
     ac1:	68 92 12 00 00       	push   $0x1292
     ac6:	6a 02                	push   $0x2
     ac8:	e8 13 04 00 00       	call   ee0 <printf>
    panic("syntax");
     acd:	c7 04 24 56 12 00 00 	movl   $0x1256,(%esp)
...
00000e2a <cond_signal>:
SYSCALL(cond_signal)
     e2a:	b8 23 00 00 00       	mov    $0x23,%eax
     e2f:	cd 40                	int    $0x40
     e31:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     e50:	74 7e                	je     ed0 <printint+0x90>
     e52:	89 d0                	mov    %edx,%eax
     e54:	c1 e8 1f             	shr    $0x1f,%eax
     e57:	84 c0                	test   %al,%al
     e59:	74 75                	je     ed0 <printint+0x90>
    neg = 1;
    x = -xx;
  ...
  if(sgn && xx < 0){
    neg = 1;
     e5d:	c7 45 c4 01 00 00 00 	movl   $0x1,-0x3c(%ebp)
    x = -xx;
     e64:	f7 d8                	neg    %eax
     e66:	89 75 c0             	mov    %esi,-0x40(%ebp)
  } else {
    x = xx;
  }
  ...
  i = 0;
     ...
     e6b:	8d 5d d7             	lea    -0x29(%ebp),%ebx
     e6e:	89 ce                	mov    %ecx,%esi
     e70:	eb 08                	jmp    e7a <printint+0x3a>
     e72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
     e78:	89 cf                	mov    %ecx,%edi
     e7a:	31 d2                	xor    %edx,%edx
     e7c:	8d 4f 01             	lea    0x1(%edi),%ecx
     e7f:	f7 f6                	div    %esi
     e81:	0f b6 92 f0 12 00 00 	movzbl 0x12f0(%edx),%edx
  }while((x /= base) != 0);
  ...
  do{
    buf[i++] = digits[x % base];
     e8a:	88 14 0b             	mov    %dl,(%ebx,%ecx,1)
  }while((x /= base) != 0);
     e8d:	75 e9                	jne    e78 <printint+0x38>
  if(neg)
     e8f:	8b 45 c4             	mov    -0x3c(%ebp),%eax
     e92:	8b 75 c0             	mov    -0x40(%ebp),%esi
     e95:	85 c0                	test   %eax,%eax
     e97:	74 08                	je     ea1 <printint+0x61>
    buf[i++] = '-';
     e99:	c6 44 0d d8 2d       	movb   $0x2d,-0x28(%ebp,%ecx,1)
     e9e:	8d 4f 02             	lea    0x2(%edi),%ecx
     ea1:	8d 7c 0d d7          	lea    -0x29(%ebp,%ecx,1),%edi
     ea5:	8d 76 00             	lea    0x0(%esi),%esi
     ea8:	0f b6 07             	movzbl (%edi),%eax
#include "user.h"
...
putc(int fd, char c)
{
  write(fd, &c, 1);
     ...
     eae:	83 ef 01             	sub    $0x1,%edi
     eb1:	6a 01                	push   $0x1
     eb3:	53                   	push   %ebx
     eb4:	56                   	push   %esi
     eb5:	88 45 d7             	mov    %al,-0x29(%ebp)
     eb8:	e8 85 fe ff ff       	call   d42 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
     ...
     ec0:	39 df                	cmp    %ebx,%edi
     ec2:	75 e4                	jne    ea8 <printint+0x68>
    putc(fd, buf[i]);
}
  ...
  neg = 0;
     ed2:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
     ed9:	eb 8b                	jmp    e66 <printint+0x26>
     edb:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
     ef2:	89 45 d0             	mov    %eax,-0x30(%ebp)
     ef5:	0f b6 1e             	movzbl (%esi),%ebx
     ef8:	83 c6 01             	add    $0x1,%esi
     efb:	84 db                	test   %bl,%bl
     efd:	0f 84 b0 00 00 00    	je     fb3 <printf+0xd3>
     f03:	31 d2                	xor    %edx,%edx
     f05:	eb 39                	jmp    f40 <printf+0x60>
     f07:	89 f6                	mov    %esi,%esi
     f09:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
     f10:	83 f8 25             	cmp    $0x25,%eax
     f13:	89 55 d4             	mov    %edx,-0x2c(%ebp)
        state = '%';
     f16:	ba 25 00 00 00       	mov    $0x25,%edx
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
...
{
  write(fd, &c, 1);
     f1d:	8d 45 e2             	lea    -0x1e(%ebp),%eax
     f20:	83 ec 04             	sub    $0x4,%esp
     f23:	88 5d e2             	mov    %bl,-0x1e(%ebp)
     f26:	6a 01                	push   $0x1
     f28:	50                   	push   %eax
     f29:	57                   	push   %edi
     f2a:	e8 13 fe ff ff       	call   d42 <write>
     f2f:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
     f38:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
     f3c:	84 db                	test   %bl,%bl
     f3e:	74 73                	je     fb3 <printf+0xd3>
    c = fmt[i] & 0xff;
    if(state == 0){
  ...
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
     f42:	0f be cb             	movsbl %bl,%ecx
     f45:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
     f48:	74 c6                	je     f10 <printf+0x30>
      if(c == '%'){
        state = '%';
      } else {
        putc(fd, c);
     ...
     f4a:	83 fa 25             	cmp    $0x25,%edx
     f4d:	75 e6                	jne    f35 <printf+0x55>
      if(c == 'd'){
     f4f:	83 f8 64             	cmp    $0x64,%eax
     f52:	0f 84 f8 00 00 00    	je     1050 <printf+0x170>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
     f58:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
     f5e:	83 f9 70             	cmp    $0x70,%ecx
     f61:	74 5d                	je     fc0 <printf+0xe0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
     f63:	83 f8 73             	cmp    $0x73,%eax
     f66:	0f 84 84 00 00 00    	je     ff0 <printf+0x110>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
     ...
     f6c:	83 f8 63             	cmp    $0x63,%eax
     f6f:	0f 84 ea 00 00 00    	je     105f <printf+0x17f>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
     f75:	83 f8 25             	cmp    $0x25,%eax
     f78:	0f 84 c2 00 00 00    	je     1040 <printf+0x160>
#include "user.h"
...
{
  write(fd, &c, 1);
     f7e:	8d 45 e7             	lea    -0x19(%ebp),%eax
     f81:	83 ec 04             	sub    $0x4,%esp
     f84:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
     f88:	6a 01                	push   $0x1
     f8a:	50                   	push   %eax
     f8b:	57                   	push   %edi
     f8c:	e8 b1 fd ff ff       	call   d42 <write>
     f91:	83 c4 0c             	add    $0xc,%esp
     f94:	8d 45 e6             	lea    -0x1a(%ebp),%eax
     f97:	88 5d e6             	mov    %bl,-0x1a(%ebp)
     f9a:	6a 01                	push   $0x1
     f9c:	50                   	push   %eax
     f9d:	57                   	push   %edi
     f9e:	83 c6 01             	add    $0x1,%esi
     fa1:	e8 9c fd ff ff       	call   d42 <write>
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
     fa6:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
#include "user.h"
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     fcf:	8b 13                	mov    (%ebx),%edx
     fd1:	e8 6a fe ff ff       	call   e40 <printint>
        ap++;
     fd6:	89 d8                	mov    %ebx,%eax
     ...
     fe3:	e9 4d ff ff ff       	jmp    f35 <printf+0x55>
     fe8:	90                   	nop
     ...
     ff8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
     ffb:	b8 e8 12 00 00       	mov    $0x12e8,%eax
    1000:	85 db                	test   %ebx,%ebx
    1002:	0f 44 d8             	cmove  %eax,%ebx
        while(*s != 0){
    1005:	0f b6 03             	movzbl (%ebx),%eax
    1008:	84 c0                	test   %al,%al
    100a:	74 23                	je     102f <printf+0x14f>
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    101e:	50                   	push   %eax
    101f:	57                   	push   %edi
    1020:	e8 1d fd ff ff       	call   d42 <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    1025:	0f b6 03             	movzbl (%ebx),%eax
    1028:	83 c4 10             	add    $0x10,%esp
    102b:	84 c0                	test   %al,%al
    102d:	75 e1                	jne    1010 <printf+0x130>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
    ...
    1031:	e9 ff fe ff ff       	jmp    f35 <printf+0x55>
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    1049:	6a 01                	push   $0x1
    104b:	e9 4c ff ff ff       	jmp    f9c <printf+0xbc>
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
    ...
    1058:	6a 01                	push   $0x1
    105a:	e9 6b ff ff ff       	jmp    fca <printf+0xea>
    105f:	8b 5d d0             	mov    -0x30(%ebp),%ebx
#include "user.h"
...
{
  write(fd, &c, 1);
    1062:	83 ec 04             	sub    $0x4,%esp
    1065:	8b 03                	mov    (%ebx),%eax
    1067:	6a 01                	push   $0x1
    1069:	88 45 e4             	mov    %al,-0x1c(%ebp)
    106c:	8d 45 e4             	lea    -0x1c(%ebp),%eax
    106f:	50                   	push   %eax
    1070:	57                   	push   %edi
    1071:	e8 cc fc ff ff       	call   d42 <write>
    1076:	e9 5b ff ff ff       	jmp    fd6 <printf+0xf6>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1081:	a1 24 19 00 00       	mov    0x1924,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    10a2:	72 1c                	jb     10c0 <free+0x40>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    10a4:	39 d0                	cmp    %edx,%eax
    10a6:	73 18                	jae    10c0 <free+0x40>
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    10c0:	8b 73 fc             	mov    -0x4(%ebx),%esi
    10c3:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    10c6:	39 d7                	cmp    %edx,%edi
    10c8:	74 19                	je     10e3 <free+0x63>
  ...
  if(p + p->s.size == bp){
    ...
    10d5:	74 23                	je     10fa <free+0x7a>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    10d7:	89 08                	mov    %ecx,(%eax)
  freep = p;
    10d9:	a3 24 19 00 00       	mov    %eax,0x1924
}
    10de:	5b                   	pop    %ebx
    10df:	5e                   	pop    %esi
    10e0:	5f                   	pop    %edi
  ...
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    10e3:	03 72 04             	add    0x4(%edx),%esi
    10e6:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    10e9:	8b 10                	mov    (%eax),%edx
    10eb:	8b 12                	mov    (%edx),%edx
    10ed:	89 53 f8             	mov    %edx,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    10f0:	8b 50 04             	mov    0x4(%eax),%edx
    10f3:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    10f6:	39 f1                	cmp    %esi,%ecx
    10f8:	75 dd                	jne    10d7 <free+0x57>
    p->s.size += bp->s.size;
    10fa:	03 53 fc             	add    -0x4(%ebx),%edx
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
  freep = p;
    10fd:	a3 24 19 00 00       	mov    %eax,0x1924
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    1102:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    1105:	8b 53 f8             	mov    -0x8(%ebx),%edx
    1108:	89 10                	mov    %edx,(%eax)
  } else
    p->s.ptr = bp;
  freep = p;
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    111c:	8b 15 24 19 00 00    	mov    0x1924,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    ...
    112d:	0f 84 a3 00 00 00    	je     11d6 <malloc+0xc6>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    113a:	76 74                	jbe    11b0 <malloc+0xa0>
    113c:	81 ff 00 10 00 00    	cmp    $0x1000,%edi
    1142:	be 00 10 00 00       	mov    $0x1000,%esi
    1147:	8d 1c fd 00 00 00 00 	lea    0x0(,%edi,8),%ebx
    114e:	0f 43 f7             	cmovae %edi,%esi
    1151:	ba 00 80 00 00       	mov    $0x8000,%edx
    1156:	81 ff ff 0f 00 00    	cmp    $0xfff,%edi
    115c:	0f 46 da             	cmovbe %edx,%ebx
    115f:	eb 10                	jmp    1171 <malloc+0x61>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    116d:	39 cf                	cmp    %ecx,%edi
    116f:	76 3f                	jbe    11b0 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    1171:	39 05 24 19 00 00    	cmp    %eax,0x1924
    1177:	89 c2                	mov    %eax,%edx
    1179:	75 ed                	jne    1168 <malloc+0x58>
  char *p;
  Header *hp;
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    117e:	53                   	push   %ebx
    117f:	e8 26 fc ff ff       	call   daa <sbrk>
  if(p == (char*)-1)
    1184:	83 c4 10             	add    $0x10,%esp
    1187:	83 f8 ff             	cmp    $0xffffffff,%eax
    118a:	74 1c                	je     11a8 <malloc+0x98>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    118c:	89 70 04             	mov    %esi,0x4(%eax)
  free((void*)(hp + 1));
    118f:	83 ec 0c             	sub    $0xc,%esp
    1192:	83 c0 08             	add    $0x8,%eax
    1195:	50                   	push   %eax
    1196:	e8 e5 fe ff ff       	call   1080 <free>
  return freep;
    119b:	8b 15 24 19 00 00    	mov    0x1924,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
    ...
    11a6:	75 c0                	jne    1168 <malloc+0x58>
        return 0;
    11a8:	31 c0                	xor    %eax,%eax
    11aa:	eb 1c                	jmp    11c8 <malloc+0xb8>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
    11b0:	39 cf                	cmp    %ecx,%edi
    11b2:	74 1c                	je     11d0 <malloc+0xc0>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    11b4:	29 f9                	sub    %edi,%ecx
    11b6:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    11b9:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    11bc:	89 78 04             	mov    %edi,0x4(%eax)
      }
      freep = prevp;
    11bf:	89 15 24 19 00 00    	mov    %edx,0x1924
      return (void*)(p + 1);
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    11d4:	eb e9                	jmp    11bf <malloc+0xaf>
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    11d6:	c7 05 24 19 00 00 28 	movl   $0x1928,0x1924
    11dd:	19 00 00 
    11e0:	c7 05 28 19 00 00 28 	movl   $0x1928,0x1928
    11e7:	19 00 00 
    base.s.size = 0;
    11ea:	b8 28 19 00 00       	mov    $0x1928,%eax
    11ef:	c7 05 2c 19 00 00 00 	movl   $0x0,0x192c
    11f6:	00 00 00 
    11f9:	e9 3e ff ff ff       	jmp    113c <malloc+0x2c>
