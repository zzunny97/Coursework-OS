...
putc(int fd, char c)
{
 ...
 628:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 62b:	b8 68 08 00 00       	mov    $0x868,%eax
...
malloc(uint nbytes)
{
 ...
 7c6:	e8 e5 fe ff ff       	call   6b0 <free>
  return freep;
 7cb:	8b 15 40 0b 00 00    	mov    0xb40,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 804:	eb e9                	jmp    7ef <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 806:	c7 05 40 0b 00 00 44 	movl   $0xb44,0xb40
 80d:	0b 00 00 
 810:	c7 05 44 0b 00 00 44 	movl   $0xb44,0xb44
 817:	0b 00 00 
    base.s.size = 0;
 81a:	b8 44 0b 00 00       	mov    $0xb44,%eax
 81f:	c7 05 48 0b 00 00 00 	movl   $0x0,0xb48
 826:	00 00 00 
